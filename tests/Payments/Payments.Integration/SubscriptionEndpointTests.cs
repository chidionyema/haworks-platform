...
public sealed class SubscriptionEndpointTests : IAsyncLifetime
{
    ...
    {
        // Arrange
        var request = new CreateSubscriptionCheckoutRequest { PriceId = "price-1", Amount = 20.0m, Currency = "USD", RedirectPath = "/success" };
    ...
    {
        // Arrange
        var request = new CreateSubscriptionCheckoutRequest { PriceId = "price-1", Amount = -5.0m, Currency = "USD", RedirectPath = "/success" };
        var client = CreateClient();
