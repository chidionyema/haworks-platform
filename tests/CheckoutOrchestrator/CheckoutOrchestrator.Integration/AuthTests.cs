...
public sealed class AuthTests : IClassFixture<CheckoutWebAppFactory>
{
    private readonly CheckoutWebAppFactory _factory;

    public AuthTests(CheckoutWebAppFactory factory)
    {
        _factory = factory;
    }

    [Fact]
    public async Task StartCheckout_returns_401_when_called_without_bearer_token()
    {
        // Arrange
