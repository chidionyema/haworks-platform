...
================================================================
  ...
  2. docs/agent-briefs/audit/L1A-extractors-redactor.md     (your specific task)
...
STEP 3 — EXECUTE
================================================================
Implement L1A-extractors-redactor.md's "Deliverable" list. Run the "Acceptance" commands. Commit per the brief's commit block.
