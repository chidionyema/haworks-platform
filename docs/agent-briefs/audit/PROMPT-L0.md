...
================================================================
  ...
  2. docs/agent-briefs/audit/L0-skeleton.md     (your specific task)
...
STEP 3 — EXECUTE
================================================================
Implement L0-skeleton.md's "Deliverable" list. Run the "Acceptance" commands. Commit per the brief's commit block.
