...
================================================================
  ...
  2. docs/agent-briefs/audit/L1C-query-api.md     (your specific task)
...
STEP 3 — EXECUTE
================================================================
Implement L1C-query-api.md's "Deliverable" list. Run the "Acceptance" commands. Commit per the brief's commit block.
