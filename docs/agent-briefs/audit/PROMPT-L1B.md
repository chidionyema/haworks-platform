...
================================================================
  ...
  2. docs/agent-briefs/audit/L1B-capture-pipeline.md     (your specific task)
...
STEP 3 — EXECUTE
================================================================
Implement L1B-capture-pipeline.md's "Deliverable" list. Run the "Acceptance" commands. Commit per the brief's commit block.
