...
================================================================
  ...
  2. docs/agent-briefs/search/B7-bff-and-smoke.md  (your specific task)
...
================================================================
  ...
  • Commit locally with a clear message:
        ...
        git commit -m "feat(search): B7 — <one-line summary>"
...
================================================================
  ...
  ✗ Modifying main, origin, or any branch other than feat/search/B7
