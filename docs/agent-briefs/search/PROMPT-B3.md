...
================================================================
  1. docs/agent-briefs/search/README.md                      (protocol, anti-spiral
                                                               rules, done-report
                                                               and blocker formats)
  2. docs/agent-briefs/search/B3-catalog-category-events.md  (your specific task)
...
================================================================
  ...
  • Commit locally with a clear message:
        ...
        git commit -m "feat(search): B3 — <one-line summary>"
...
================================================================
  ...
  ✗ Modifying main, origin, or any branch other than feat/search/B3
