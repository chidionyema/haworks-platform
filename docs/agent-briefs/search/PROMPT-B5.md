...
================================================================
  ...
  2. docs/agent-briefs/search/B5-indexer.md   (your specific task)
...
================================================================
  ...
  • Commit locally with a clear message:
        ...
        git commit -m "feat(search): B5 — <one-line summary>"
...
================================================================
  ...
  ✗ Modifying main, origin, or any branch other than feat/search/B5
