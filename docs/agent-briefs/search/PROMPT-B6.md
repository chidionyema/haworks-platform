...
Run these shell commands in order. If any fail, STOP and report.
  ...
  # Precondition: B1+B2 must be merged into feat/search-service-spec.
  if [ ! -f "src/Search/Search.Application/Interfaces/ISearchIndex.cs" ]; then
      echo "BLOCKER: B2 deliverable missing — ISearchIndex.cs not found." >&2
      echo "The user must merge B1 and B2 into feat/search-service-spec" >&2
...
================================================================
  ...
  2. docs/agent-briefs/search/B6-search-endpoint.md (your specific task)
...
================================================================
  ...
  • Commit locally with a clear message:
        ...
        git commit -m "feat(search): B6 — <one-line summary>"
...
================================================================
  ...
  ✗ Modifying main, origin, or any branch other than feat/search/B6
