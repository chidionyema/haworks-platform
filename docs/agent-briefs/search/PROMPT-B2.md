...
================================================================
  ...
  2. docs/agent-briefs/search/B2-meili-schema.md (your specific task)
...
================================================================
  ...
  • Commit locally with a clear message:
        ...
        git commit -m "feat(search): B2 — <one-line summary>"
...
================================================================
  ...
  ✗ Modifying main, origin, or any branch other than feat/search/B2
