...
public static class PaymentsActivities
{
    ...
    public static readonly Counter<long> RefundStuckAwaitingProvider = Meter.CreateCounter<long>("payments.refund.stuck_awaiting_provider", description: "Refund sagas stuck in AwaitingProviderConfirmation for > 2 hours");
}
