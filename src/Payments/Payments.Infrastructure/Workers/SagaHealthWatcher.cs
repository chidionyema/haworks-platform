...
public sealed class SagaHealthWatcher : BackgroundService
{
    ...
    private static readonly TimeSpan RefundAwaitingProviderThreshold = TimeSpan.FromHours(2);
    ...
    private async Task TickAsync(CancellationToken ct)
    {
        ...
        await CheckRefundStuckAwaitingProvider(db, ct);
    ...
    private async Task CheckRefundStuckAwaitingProvider(PaymentDbContext db, CancellationToken ct)
    {
        var deadline = DateTime.UtcNow - RefundAwaitingProviderThreshold;
