...
namespace Haworks.Location.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260527004923_SyncModelSnapshot2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Haworks.BuildingBlocks.Idempotency.IdempotencyJournalEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("IdempotencyJournal", "location");
                });

            modelBuilder.Entity("Haworks.Location.Domain.Entities.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Street", "City", "Postcode", "Country")
                        .IsUnique()
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("OutboxMessage", "location");
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("OutboxState", "location");
                });
