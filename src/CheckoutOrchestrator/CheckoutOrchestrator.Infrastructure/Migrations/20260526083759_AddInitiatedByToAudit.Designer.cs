...
namespace Haworks.CheckoutOrchestrator.Infrastructure.Migrations
{
    ...
    [Migration("20260526083759_AddInitiatedByToAudit")]
    partial class AddInitiatedByToAudit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Haworks.BuildingBlocks.Messaging.SagaTransitionAuditEntry", b =>
                {
                    ...
                    b.ToTable("SagaTransitionAudit", "checkout");
                });
            ...
            modelBuilder.Entity("Haworks.CheckoutOrchestrator.Domain.CheckoutSagaState", b =>
                {
                    ...
                    b.HasIndex("CurrentState", "CreatedAt")
                        .HasDatabaseName("IX_CheckoutSagas_CurrentState_CreatedAt");

                    b.HasIndex("IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("IX_CheckoutSagas_IdempotencyKey")
