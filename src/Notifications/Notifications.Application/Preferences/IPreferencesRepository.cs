...
public interface IPreferencesRepository
{
    ...
    /// </summary>
    Task<NotificationPreference?> GetAsync(string userId, string category, NotificationChannel channel, CancellationToken ct = default);
    ...
    /// </summary>
    Task<IReadOnlyList<NotificationPreference>> GetAllForUserAsync(string userId, CancellationToken ct = default);
    ...
    /// </summary>
    Task<int> GetSendCountAsync(string bucketKey, DateTime windowStart, CancellationToken ct = default);
}
