...
public interface IPayoutGateway
{
    ...
    Task<(string ExternalId, PayoutStatus Status)> InitiatePayoutAsync(string providerId, long amountCents, string currency, string? description = null, string? idempotencyKey = null, CancellationToken ct = default);
}
